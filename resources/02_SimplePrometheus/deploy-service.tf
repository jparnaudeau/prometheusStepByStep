...
module "ecs-fargate-task-definition" {
  ...
  container_definitions = [module.container_definition_prometheus.json_map]
  #container_definitions = [module.container_definition_prometheus.json_map,module.container_definition_ecsdiscovery.json_map]
  #container_definitions = [module.container_definition_prometheus.json_map,module.container_definition_ecsdiscovery.json_map,module.container_definition_custom_exporter.json_map]
...
module "container_definition_prometheus" {
  ...
  environment = [
    ...
    { name = "PROM_PORT", value = 9090 },
    { name = "PROM_CONF_DIR", value = "/etc/prometheus" },
    { name = "STORAGE_TSDB_PATH", value = "/prometheus-data" },
    { name = "STORAGE_TSDB_RETENTION", value = "30d" },
  ]
